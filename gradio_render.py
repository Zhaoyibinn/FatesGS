...
def gradio_render_input(model_path,source_path):
# if __name__ == "__main__":
    ...
    # input_root_dir = "DTU/set_23_24_33/scan24"
    # args.source_path = input_root_dir
    args.resolution = 2
    args.vggt = True
    args.iterations = 1000
    args.voxel_size = 0.0015
    ...
    if not args.skip_mesh:
        ...
        file_dir, file_name = os.path.split(os.path.join(train_dir, name))
        file_base, _ = os.path.splitext(file_name)
        output_file = os.path.join(file_dir, f"{file_base}.glb")
        mesh = trimesh.load(os.path.join(train_dir, name), file_type='ply')
