...
input_path = "output/origin/scan24/train/ours_1/fuse_post.ply"
input_path_3 = "output/origin/scan24/train/ours_1000/fuse_post.ply"

output_path_2 = "output/origin/scan24/train/vggt_align_culled.ply"
output_path = "output/origin/scan24/train/ours_1_align_culled.ply"
output_path_3 = "output/origin/scan24/train/ours_1000_align_culled.ply"
...
os.system(f"python zyb_tools/eval_dtu/eval.py --data {output_path} --scan {scan} --mode pcd --dataset_dir /home/zhaoyibin/3DRE/3DGS/GSDF/data/DTU --vis_out_dir output/origin/scan{scan}/train/eval_ours_1")
...
os.system(f"python zyb_tools/eval_dtu/eval.py --data {output_path_3} --scan {scan} --mode pcd --dataset_dir /home/zhaoyibin/3DRE/3DGS/GSDF/data/DTU--vis_out_dir output/origin/scan{scan}/train/eval_ours_1000")
