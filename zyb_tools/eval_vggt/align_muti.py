...
parser.add_argument('--scan', type=int, help='scan')
...
for scan in [args.scan]:
    ...
    input_path = os.path.join(input_path_root,f"scan{scan}/train/ours_{iteration}/fuse_post.ply")
    # input_path_2 = os.path.join(input_path_root,f"scan{scan}/train/ours_1000/fuse_post.ply")
    # input_path_3 = os.path.join(input_path_root,f"scan{scan}/train/ours_15000/fuse.ply")
    ...
    # output_path_3 = os.path.join(output_path_root,f"scan{scan}/train/ours_15000_align_culled.ply")
    ...
    # input_ply_3_regmasked_numpy = mask_dtu(scan,input_ply_3_rescale_numpy)
    # 用DTU的mask裁剪点云
    ...
    # eval_cd_savedir_3 = os.path.join(eval_cd_savedir_root,"eval_ours_15000")
    ...
    # os.makedirs(eval_cd_savedir_3,exist_ok=True)
    ...
    # os.system(f"python zyb_tools/eval_dtu/eval.py --data {output_path_3} --scan {scan} --mode pcd --dataset_dir /home/zhaoyibin/3DRE/3DGS/GSDF/data/DTU --vis_out_dir {eval_cd_savedir_3}")
