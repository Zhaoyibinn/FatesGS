...
def convert_png_to_three_channels(root_path):

    for file_name in os.listdir(root_path):
        input_folder = os.path.join(root_path, file_name, "images")
        output_folder = os.path.join(root_path, file_name, "images")
...
def main():
    ...
    parser.add_argument('--root_path', default="/home/zhaoyibin/3DRE/3DGS/FatesGS/DTU/set_23_24_33_metric", help='输入文件夹路径')
    ...
    convert_png_to_three_channels(args.root_path)
