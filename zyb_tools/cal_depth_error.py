...
scenes = ["3DGS", "2DGS", "Sparse2DGS_OUT", "origin", "dust3r_abs_trim_splitmix_diff"]
...
for scene in scenes:
    ...
    for scan_name in scans:
        ...
        for idx in range(3):
            ...
            if os.path.exists(os.path.join(origin_path_root, scan_name, f"train/ours_15000/vis/depth_0000{idx}.tiff")):
            ...
            elif os.path.exists(os.path.join(origin_path_root, scan_name, f"train/ours_7000/vis/depth_0000{idx}.tiff")):
                render_img = cv2.imread(os.path.join(origin_path_root, scan_name, f"train/ours_7000/vis/depth_0000{idx}.tiff"), cv2.IMREAD_ANYDEPTH)
            # 调整GT图像大小并归一化
